...
module.exports = {
  ...
  twitter: {
    consumerKey: process.env.TWITTER_KEY || 'omxSPiY7hOsnv8TwFsuIn7xg2',
    consumerSecret: process.env.TWITTER_SECRET  || 'oDmLRJ8D5y38kC7H68OwUHn0fVo7Vn3FjiKXqWX9u5xTR4NKQ7',
